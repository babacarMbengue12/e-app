 ...
 */
final class Version20210509160222 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE cart (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, family_id INTEGER DEFAULT NULL, title VARCHAR(255) NOT NULL, ordered BOOLEAN NOT NULL, sended BOOLEAN NOT NULL)');
